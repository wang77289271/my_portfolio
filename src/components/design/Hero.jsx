...
export const BackgroundCircles = ({ parallaxRef }) => {
  ...
  return (
    <div className='absolute -top-[42.375rem] left-1/2 w-[78rem] aspect-square border border-n-2/5 rounded-full -translate-x-1/2 md:-top-[38.5rem] xl:-top-[32rem] z-1'>
      <Rings />
...
export const HeaderBackgroundCircles = ({ parallaxRef }) => {
  const [mounted, setMounted] = useState(false)
  ...
  return (
    <div className='absolute w-[78rem] aspect-square border border-n-2/5 rounded-full -translate-x-[100%] md:-top-[38.5rem] xl:-top-[32rem] z-1'>
      {/* <Rings /> */}
